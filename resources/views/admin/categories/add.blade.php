    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="{{route('store_category')}}" class="">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            <textarea name="desc" id="desc" class="form-control @error('desc') is-invalid @enderror" placeholder="Description">{{ old('desc') }}</textarea>
